...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('api.admin.project.update', [$project]) }}" id="form" method="PUT" enctype="multipart/form-data">
            ...
            <input id="title" type="text" name="title" class="form-control text-white" style="background-color: #222" value="{{ $project->title }}">

            <label for="summary">Summary</label>
            <textarea id="summary" class="form-control text-white" style="background-color: #222" name="summary">{{ $project->summary }}</textarea>

            <label for="description">Description</label>
            <textarea id="description" class="form-control text-white" style="background-color: #222" name="description" rows="10">{{ $project->description }}</textarea>
            ...
            <input id="url" type="url" name="url" class="form-control text-white" style="background-color: #222" value="{{ $project->url }}">

            <label for="repository">Repository</label>
            <input id="repository" type="url" name="repository" class="form-control text-white" style="background-color: #222" value="{{ $project->repo_url }}">
